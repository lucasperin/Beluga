...
public class PrintTree {
    ...
    public void printAtribNode(AtribNode x) {
        ...
        String a = (x.cond == null) ? "null" : String.valueOf(x.cond.number);

        System.out.println();
        System.out.print(x.number + ": AtribNode ===> " + x.expr1.number + " " +
           a + " " + x.expr2.number);
        printExpreNode(x.expr1);
        printAtribCondNode(x.cond);
        printExpreNode(x.expr2);
    }

    // ------------------------- Comando de atribuição condicional -------------------
    public void numberAtribCondNode(ConditionalNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printAtribCondNode(ConditionalNode x) {
        if (x == null) {
            return;
        }

        String e1 = (x.expr1 == null) ? "null" : String.valueOf(x.expr1.number);
        String e2 = (x.expr2 == null) ? "null" : String.valueOf(x.expr2.number);

        System.out.print("\n" + x.number + ": ConditionalNode ===> " + e1 + " " + e2);
    ...
    public void printStatementNode(StatementNode x) {
        if (x instanceof BlockNode) {
        	...
        	printSwitchStatNode((SwitchStatNode) x);
        } else if (x instanceof WhileStatNode ) {
        	printWhileStatNode( (WhileStatNode) x);
        }
    ...
    public void numberStatementNode(StatementNode x) {
        if (x instanceof BlockNode) {
        	...
        	numberSwitchStatNode((SwitchStatNode) x);
        } else if (x instanceof WhileStatNode ) {
        	numberWhileStatNode( (WhileStatNode) x);
        } 
    }
    
 // --------------------------- Comando switch --------------------

    public void numberSwitchStatNode(SwitchStatNode x) {
        if (x == null) {
            return;
        }
        ...
        x.number = kk++;
        numberExpreNode(x.expr);
        numberCaseListNode(x.caselist);
    }

    public void printSwitchStatNode(SwitchStatNode x) {
        if (x == null) {
            return;
        }
        ...
        printExpreNode(x.expr);
        printCaseListNode(x.caselist);
    }

// --------------------------- Comando caselist --------------------

    public void numberCaseListNode(CaseListNode x) {
        if (x == null) {
            return;
        }

        x.number = kk++;
        numberCaseStatNode(x.casenode);
        numberCaseListNode(x.caselist);
    }

    public void printCaseListNode(CaseListNode x) {
        if (x == null) {
            return;
        }
        ...
        String a = x.casenode == null ? "null" : String.valueOf(x.casenode.number);
        String b = x.caselist == null ? "null" : String.valueOf(x.caselist.number);	
        System.out.print(x.number + ": CaseListNode ===> " + " " + a + " " + b);
  
        printCaseStatNode(x.casenode);
        printCaseListNode(x.caselist);
    }

// --------------------------- Comando case --------------------

    public void numberCaseStatNode(CaseStatNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printCaseStatNode(CaseStatNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": CaseNode ===> " +
            ((x.expr == null) ? "null" : String.valueOf(x.expr.number)) + " " +
            x.stat.number);
    ...
    public void numberWhileStatNode(WhileStatNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printWhileStatNode(WhileStatNode x) {
        if (x == null) {
            return;
        }
