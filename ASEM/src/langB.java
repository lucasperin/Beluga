...
RecoverySet f1 = new RecoverySet(ASSIGN).union(g);
      ...
      {if (true) return new AtribNode(t1, e1, e2, c1);}
      } catch (ParseException e) {
  ...
  final public ConditionalNode conditional(RecoverySet g) throws ParseException, ParseEOFException {
...
RecoverySet f1 = new RecoverySet(DDOT).union(g);
      try {
        t1 = jj_consume_token(QUESTIONMARK);
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case int_constant:
        case string_constant:
        case null_constant:
     ...
     {if (true) return new ConditionalNode(t1, e1, e2);}
      } catch (ParseException e) {
...
RecoverySet f1 = new RecoverySet(SEMICOLON).union(g),
  ...
  final public WhileStatNode whilestat(RecoverySet g) throws ParseException, ParseEOFException {
...
RecoverySet f1 = new RecoverySet(RPAREN).union(g);
      try {
        ...
        jj_consume_token(RPAREN);
        s1 = statement(g);
     {if (true) return new WhileStatNode(t, e1, s1);}
      } catch (ParseException e) {
  ...
  final public SwitchStatNode switchstat(RecoverySet g) throws ParseException, ParseEOFException {
...
RecoverySet f1 = new RecoverySet(RPAREN).union(g),
      ...
      try {
        ...
        c1 = caselist(f2);
        jj_consume_token(RBRACE);
     {if (true) return new SwitchStatNode(t, e1, c1);}
      } catch (ParseException e) {
  ...
  final public CaseListNode caselist(RecoverySet g) throws ParseException, ParseEOFException {
    trace_call("caselist");
    try {
...
Token t = null;
     ...
     {if (true) return new CaseListNode(t, c1, c2);}
      } catch (ParseException e) {
  ...
  final public CaseStatNode casestat(RecoverySet g) throws ParseException, ParseEOFException {
    trace_call("casestat");
    try {
ExpreNode s1 = null;
...
Token t = null;
      try {
        ...
        jj_consume_token(DDOT);
        s2 = statement(g);
           {if (true) return new CaseStatNode(t, s1, s2);}
      } catch (ParseException e) {
...
Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2001,0x2001,0x2000,0x10000,0x2000,0x0,0x4000,0xa100000,0xa100000,0x0,0x0,0x0,0xa100000,0x0,0xa100000,0x0,0x0,0xa100000,0x0,0xa100000,0x35c61000,0x0,0x200000,0x200000,0x200000,0x0,0x8000,0x0,0x0,0x0,0x40000000,0x35c61000,0x0,0x0,0x0,0xa100000,0x0,0xa100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x42,0x40,0x4000,0x20000,0x4000,0x42,0x4000,0x40,0x4000,0x20000,0x40,0x4000,0x40,0x11041,0x100000,0x3000047c,0x3000047c,0x3000047c,0x3000047c,0x0,0x40,0x3000047c,0x40,0x0,0x11041,0x44000,0x4000,0x40000,0x40,0x4000,0x40,0xfc00000,0xfc00000,0x30000000,0x30000000,0xc0000000,0xc0000000,0x30000000,0x30000000,0x47c,0x20000,0x3000047c,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6,0x6,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,};
   }
